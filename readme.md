...
* Plantilla de microservicios con Net8 (Top level statements, global usings, records, more...)
...
> dotnet new install CeibaBlockNet8.1.0.0.nupkg

Solo se debe instalar una sola vez, y para crear una nueva solucion : 

> dotnet new CeibaBlockNet8 -n [Nombre Proyecto]
